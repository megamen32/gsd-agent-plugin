...
<required_reading>
@/tmp/gsd-npm-codex-stage/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/tmp/gsd-npm-codex-stage/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /tmp/gsd-npm-codex-stage
                  → checks /tmp/gsd-npm-codex-stage/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /tmp/gsd-npm-codex-stage/get-shit-done
                  → writes to /tmp/gsd-npm-codex-stage/get-shit-done/hooks/
...
@/tmp/gsd-npm-codex-stage/get-shit-done/references/thinking-models-debug.md
...
- Read @/tmp/gsd-npm-codex-stage/get-shit-done/references/common-bug-patterns.md
