...
@/tmp/gsd-npm-codex-stage/get-shit-done/references/thinking-models-research.md
...
```bash
node "/tmp/gsd-npm-codex-stage/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
