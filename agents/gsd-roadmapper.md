...
Reference full template: `/tmp/gsd-npm-codex-stage/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/tmp/gsd-npm-codex-stage/get-shit-done/templates/state.md`.
