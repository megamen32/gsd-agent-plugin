...
<reference>
@/tmp/gsd-npm-codex-stage/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/tmp/gsd-npm-codex-stage/get-shit-done/references/user-profiling.md` to load:
