...
<!-- For checkpoint task examples and patterns, see @/tmp/gsd-npm-codex-stage/get-shit-done/references/checkpoints.md -->
...
See `/tmp/gsd-npm-codex-stage/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/tmp/gsd-npm-codex-stage/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/tmp/gsd-npm-codex-stage/get-shit-done/workflows/verify-phase.md` for verification logic.
