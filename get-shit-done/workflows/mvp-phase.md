...
<required_reading>
@/tmp/gsd-npm-codex-stage/get-shit-done/references/user-story-template.md
@/tmp/gsd-npm-codex-stage/get-shit-done/references/spidr-splitting.md
@/tmp/gsd-npm-codex-stage/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/tmp/gsd-npm-codex-stage/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/tmp/gsd-npm-codex-stage/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/tmp/gsd-npm-codex-stage/get-shit-done/references/spidr-splitting.md`. Briefly:
