...
Key references:
- @/tmp/gsd-npm-codex-stage/get-shit-done/references/ui-brand.md (display patterns)
- @/tmp/gsd-npm-codex-stage/agents/gsd-user-profiler.md (profiler agent definition)
- @/tmp/gsd-npm-codex-stage/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md" "/tmp/gsd-npm-codex-stage/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/tmp/gsd-npm-codex-stage/get-shit-done/references/user-profiling.md`
...
Reference: @/tmp/gsd-npm-codex-stage/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /tmp/gsd-npm-codex-stage/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /tmp/gsd-npm-codex-stage/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /tmp/gsd-npm-codex-stage/AGENTS.md"
...
```bash
BACKUP_PATH="/tmp/gsd-npm-codex-stage/USER-PROFILE.backup.md"
```
...
Your profile:    /tmp/gsd-npm-codex-stage/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /tmp/gsd-npm-codex-stage/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /tmp/gsd-npm-codex-stage/AGENTS.md
```
