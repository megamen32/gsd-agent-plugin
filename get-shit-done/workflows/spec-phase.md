...
```bash
INIT=$(node "/tmp/gsd-npm-codex-stage/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/tmp/gsd-npm-codex-stage/get-shit-done/templates/spec.md.
