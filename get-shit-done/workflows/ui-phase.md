...
```markdown
Read /tmp/gsd-npm-codex-stage/agents/gsd-ui-researcher.md for instructions.
...
Template: /tmp/gsd-npm-codex-stage/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /tmp/gsd-npm-codex-stage/agents/gsd-ui-checker.md for instructions.
