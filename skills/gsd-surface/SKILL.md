...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `../../skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=../../skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=../../commands/gsd
AGENTS_DIR=../../agents
```
...
<execution_context>
Surface state file: `../../skills/.gsd-surface.json`
Install profile marker: `../../skills/.gsd-profile`
Engine module: `../../get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `../../get-shit-done/bin/lib/clusters.cjs`
</execution_context>
